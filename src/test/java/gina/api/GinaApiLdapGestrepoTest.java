...
public class GinaApiLdapGestrepoTest
{
	...
	GinaApiLdapConfiguration ldapConf = new GinaApiLdapConfiguration(server, base, user, password, GinaApiLdapUtils.LDAP_DEFAULT_TIMEOUT);
	...
	try
	{
	    boolean ret = api.hasUserRole(LDAP_APPLICATION_TEST_USER, LDAP_APPLICATION_TEST_DOMAINE_APPLICATION, LDAP_APPLICATION_TEST_ROLE);
